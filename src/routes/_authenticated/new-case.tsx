...
function Field({ label, name, registerField, ...props }: { label: string; name: keyof Fields; registerField: RegisterField } & Omit<React.InputHTMLAttributes<HTMLInputElement>, "name" | "type" | "value" | "defaultValue">) {
