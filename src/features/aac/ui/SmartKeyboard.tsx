...
export function SmartKeyboard() {
  ...
  const addChip = useCallback(
    (r: AacResult) => {
      ...
      // Do not focus or blur the search input here. The user's current native
      // focus is left entirely to the browser/WebView, so tapping a result or
      // another control cannot trigger an artificial IME lifecycle.
      setQuery("");
    },
    [],
  );
